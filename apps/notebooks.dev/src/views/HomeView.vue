      ...
      <v-card>
        ...
        <v-card-text class="pb-0">
          ...
          <v-text-field
            ...
            class="mb-3"
            density="comfortable"
            :label="addType === 'notebook' ? 'Notebook Title' : 'Category Title'"
            variant="outlined"
          />
      ...
      <div class="category-header">
        <h2 class="category-title">
          ...
          <span v-if="searchQuery" class="result-count">
            ({{ category.notebooks.length }} {{ category.notebooks.length === 1 ? 'notebook' : 'notebooks' }})
          </span>
        </h2>
        <v-btn
          color="#23624d"
...
<script setup lang="ts">
  ...
  const featuredNotebook = ref({
    ...
    date: '2024-03-25',
    bookmarked: true,
    preview: 'Explore cutting-edge machine learning algorithms, neural networks, and predictive modeling. This comprehensive guide covers everything from basic regression to deep learning architectures.',
  })
  ...
  const categories = ref([
    {
      ...
      notebooks: [
        { id: 101, title: 'Pandas Tutorial', coverColor: '#1a1a1a', date: '2024-03-15', bookmarked: true },
        { id: 102, title: 'NumPy Basics', coverColor: '#8B0000', date: '2024-03-10', bookmarked: false },
        { id: 103, title: 'Machine Learning Intro', coverColor: '#004d00', date: '2024-02-28', bookmarked: false },
        { id: 104, title: 'Data Cleaning', coverColor: '#1a1a1a', date: '2024-03-20', bookmarked: true },
      ],
    },
    {
      id: 2,
      title: 'Class Notes',
      notebooks: [
        { id: 201, title: 'Math – Unit 5', coverColor: '#00008B', date: '2024-03-18', bookmarked: false },
        { id: 202, title: 'History Chapter 3', coverColor: '#1a1a1a', date: '2024-03-12', bookmarked: true },
        { id: 203, title: 'Chemistry Lab 2', coverColor: '#4B0082', date: '2024-03-05', bookmarked: false },
      ],
    },
    {
      id: 3,
      title: 'Projects',
      notebooks: [
        { id: 301, title: 'Stock Predictor', coverColor: '#8B4513', date: '2024-01-22', bookmarked: false },
        { id: 302, title: 'Weather Dashboard', coverColor: '#004d00', date: '2024-03-08', bookmarked: false },
      ],
    },
  ])
  ...
  function addItem () {
    if (addType.value === 'category') {
      ...
      // Add new notebook
      const category = categories.value.find(c => c.id === newItem.value.categoryId)
      if (category) {
